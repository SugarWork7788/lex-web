...
- [x] **Phase 8.1: DV scraper navigation hotfix** [INSERTED 2026-05-11] — stateless GET rewrite + historical-issue smoke + dv_acts(issue_id) index; 9 corrupt shells repaired (335 distinct idMats); full backfill running in background; 3 runtime bugs caught + fixed inline (jsessionid regex, materiali.faces title-extraction, sticky-session aliasing)
